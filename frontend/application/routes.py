...
def home():
    ...
    prize_gen = requests.post('http://service4-api:5000/service4/prize_gen', data=prize_gen.text)
    ...
    return render_template('index.html', name_gen1=name_gen.text, number_gen1=number_gen.text, prize_gen1=prize_gen.text)
